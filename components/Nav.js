...
const Nav = () => {
  ...
  return (
  <nav className='fixed bottom-0 flex flex-col items-center xl:justify-center gap-y-4 h-max mt-auto xl:right-[2%] z-50 top-0 w-full xl:max-w-md xl:w-16 xl:h-screen'>
    {/* inner */}
